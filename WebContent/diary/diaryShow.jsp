...
<script type="text/javascript">
	function diaryDelete(diaryId){
		if(confirm("您确定要删除这个日志吗？")){
			window.location="delete?diaryId="+diaryId;
		}
	}
</script>
<div class="data_list">
		...
		<div>
			...
			<div class="diary_action">
				<button class="btn btn-primary" type="button" onclick="javascript:window.location='preSave?diaryId=${diary.diaryId}'">修改日志</button>
