<%@ page language="java" contentType="text/html; charset=UTF-8"
    pageEncoding="UTF-8"%>
<%@ page language="java" import="com.tan.entity.User"%>
<%
...
<div class="container">
	...
	<p align="center" style="padding-top: 15px;"><a href="http://www.cnblogs.com/tanzq/" target="_blank">©版权所有&nbsp;&nbsp;2018&nbsp;&nbsp;Fantasy作品</a></p>
	</form>
</div>
</body>
</html>