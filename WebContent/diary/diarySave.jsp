...
<div class="data_list">
	<div class="data_list_title">
		...
		<form action="${pageContext.request.contextPath}/diary/save" method="post" onsubmit="return checkForm()">
				<div class="diary_title">
					日志主题：<input type="text" id="title1"  name="title" value="${diary.title }" class="input-xlarge"  style="margin-top:5px;height:30px;"/>
				</div>
				<div>
