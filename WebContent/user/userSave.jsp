...
<div class="data_list">
	...
	<div class="row-fluid" style="padding-top:20px;">
		...
		<div class="span8">
			<form action="${pageContext.request.contextPath}/user/save" method="post" enctype="multipart/form-data" onsubmit="return checkForm()">
				<input type="hidden" id="userId" name="userId" value="${currentUser.userId }"/>
				<table width="100%">
					<tr>
						<td width="20%">头像路径：</td>
						<td><input type="file" id="imagePath" accept="image/*" name="imagePath"/></td>
					</tr>
					<tr>
						<td>个人昵称：</td>
